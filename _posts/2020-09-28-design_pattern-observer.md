...
Node.js 의 이벤트 루프를 활용하면 기존 콜백패턴과는 다른 방법으로 개발할 수 있습니다. 특히, Node.js 에서 많은 모듈들을 사용하는데 이 모듈간의 결합도를 끊을 수 있어 관심사의 분리 원칙을 깔끔하게 지킬 수 있도록 설계할 수 있습니다. 

그러면 간단하게 실제로 Node.js 에서는 어떻게 구성요소를 정의하고 있는지 알아보겠습니다. 

우선 만약 Observer 패턴을 사용하지 않았을 경우 어떤 식으로 개발되었을지 설명드리겠습니다. 언어는 타입스크립트 기반이고 유저가 회원가입 한다는 가정을 하도록 하겠습니다.
